...
private:
  pair<Data, instant> rellotge;
  map<Data, Tasca> tasques;
  map<string, map<Data, Tasca*> > etiquetes;
  map<Data, Tasca*> menu_map;
  vector<pair<Data, Tasca*> > menu;
  
/** \brief Consulta les tasques d'un interval de temps que compleixen l'expressio
 * \pre \e dia1 anterior a \e dia2 i \e dia1 posterior o igual a la data del p.i.
 * \post el menú conté les tasques no passadaes entre el dia \e dia1 i \e dia2
 * tal que el conjunt d'etiquetes de les tasques compleix \e expressio
 */
void buscar_interval(const Data &d1, const Data &d2, string expressio);

void buscar_interval_rel();
...
* el conjunt d'etiquetes de les tasques compleix \e expressio
* i es mostra el menú */
